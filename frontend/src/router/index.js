...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/app/rewrite', component: UserRewritePage, meta: { auth: 'user', title: '降AIGC' } },
    { path: '/app/rewrite/records', component: UserRewriteRecordsPage, meta: { auth: 'user', title: '降AIGC记录' } },
