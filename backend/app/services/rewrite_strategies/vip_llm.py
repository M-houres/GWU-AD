...
from app.services.vip_rewrite_runtime import execute_vip_rewrite_text


def rewrite(db, *, task: Task | None, text: str, report_summary: dict | None = None) -> dict:
    result = execute_vip_rewrite_text(
        db,
    ...
    return {
        ...
        "rule_trace": {
            ...
            "applied_rules": ["llm:vip:rewrite:paragraph_style_transfer"],
            "protected_hits": [],
