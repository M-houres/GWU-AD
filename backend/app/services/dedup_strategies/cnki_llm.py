...
from app.services.cnki_dedup_runtime import execute_cnki_dedup_text


def rewrite(db, *, task: Task | None, text: str, report_summary: dict | None = None) -> dict:
    result = execute_cnki_dedup_text(
        db,
    ...
    return {
        ...
        "rule_trace": {
            ...
            "applied_rules": ["llm:cnki:dedup:paragraph_style_transfer"],
            "protected_hits": [],
